...
const Skiper31 = () => {
  ...
  return (
    <div className="w-full bg-black">
        ...
        {/* Блок 2 — Filosofía Con Efecto TextColor */}
        <div
          ref={targetRef2}
          className="relative -mt-[50vh] box-border flex h-[200vh] flex-col items-center justify-center bg-black"
        >
          <div className="w-full flex-col flex items-center justify-center p-[2vw]">
                  ...
                  {["DEFINIR", "DISEÑAR", "DESARROLLAR"].map((word, i) => {
                      ...
                      return (
                          <div key={i} className="relative py-2">
                              ...
                              <h2 className="text-6xl md:text-[10rem] font-black uppercase tracking-tighter text-white/5 leading-[0.9]">
                                  {word}
                              </h2>
                              ...
                              <motion.h2 
                                  ...
                                  className="absolute inset-0 text-6xl md:text-[10rem] font-black uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-white to-teal-500 leading-[0.9] drop-shadow-[0_0_15px_rgba(94,234,212,0.3)]"
                              >
                                  {word}
                              </motion.h2>
                          </div>
        ...
        <div
          ref={targetRef3}
          className="relative -mt-[50vh] box-border flex h-[150vh] flex-col items-center justify-center gap-[4vw] overflow-hidden bg-black p-[2vw]"
        >
          <p className="flex items-center justify-center gap-3 text-3xl md:text-5xl font-black tracking-tighter uppercase text-white">
