...
const Skiper31 = () => {
  ...
  return (
    <div className="w-full bg-black">
        ...
        <div
          ref={targetRef2}
          className="relative -mt-[20vh] md:-mt-[50vh] box-border flex h-[200vh] flex-col items-center justify-center bg-black"
        >
        ...
        <div
          ref={targetRef3}
          className="relative -mt-[10vh] md:-mt-[50vh] box-border flex h-[150vh] flex-col items-center justify-center gap-[4vw] overflow-hidden bg-black p-6 md:p-[2vw]"
        >
