...
export function MagneticText({ 
  ...
  return (
    ...
    >
      ...
      <span className={cn("font-bold tracking-tighter text-foreground tracking-wide", textClassName)}>{text}</span>

      <div
        ref={circleRef}
        className="absolute top-0 left-0 pointer-events-none rounded-full bg-zinc-900 border border-white/20 overflow-hidden"
        style={{
      ...
      >
        <div
          ref={innerTextRef}
          className="absolute flex items-center justify-center bg-zinc-950/80"
          style={{
